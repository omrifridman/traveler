...
def init_db():
    with get_db() as db:
        ...
        try:
            ...
            db.execute("INSERT INTO users (username, password, role) VALUES ('t3', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t4', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t5', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t6', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t7', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t8', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t9', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t10', 'pass', 'user')")
            db.execute("INSERT INTO users (username, password, role) VALUES ('t11', 'pass', 'user')")
